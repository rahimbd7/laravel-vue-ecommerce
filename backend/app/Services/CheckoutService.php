...
class CheckoutService
{
    ...
    public function processCheckout(array $data)
    {
        ...
        if (empty($data['shipping_address']) || empty($data['shipping_city']) || empty($data['shipping_country'])) {
            throw new \Exception('Shipping address is required.');
        }

        if (empty($data['billing_address']) || empty($data['billing_city']) || empty($data['billing_country'])) {
