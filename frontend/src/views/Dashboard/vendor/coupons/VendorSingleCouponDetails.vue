      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex flex-wrap gap-2">
          <Button 
            ...
            label="Edit" 
            size="small"
            @click="router.push(`/dashboard/vendor/coupons/${couponId}/edit`)"
            severity="primary"
          />
          <Button 
          ...
          <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p class="text-lg font-bold text-gray-900 capitalize">
                  {{ coupon.applies_to?.replace('_', ' ') || 'All' }}
                </p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p class="text-lg font-bold text-gray-900">{{ coupon.vendor?.business_name || 'Your Store' }}</p>
              </div>
            </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6">
            ...
            <div class="space-y-3">
              ...
              <div class="flex justify-between">
                ...
                <span class="text-sm font-bold text-gray-900">{{ coupon.vendor?.business_name || 'Your Store' }}</span>
              </div>
            </div>
          </div>
...
const fetchCoupon = async () => {
  ...
  error.value = ''
  try {
    const response = await vendorApi.getCoupon(couponId)
...
const toggleStatus = async () => {
  ...
  try {
    ...
    await vendorApi.toggleCouponStatus(couponId)
...
const confirmDelete = () => {
  ...
  confirm.require({
    ...
    accept: async () => {
      try {
        await vendorApi.deleteCoupon(couponId)
        toast.add({
          severity: 'success',
          summary: 'Deleted',
        ...
        router.push('/dashboard/vendor/coupons')
      } catch (err: any) {
        toast.add({
          severity: 'error',
          summary: 'Error',
